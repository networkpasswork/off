...
constexpr ::std::ptrdiff_t m_fSecondHook = 0xB1C80;
constexpr ptrdiff_t fakeLevel = 0x51F66D4;
constexpr ptrdiff_t fakeRank = 0xD2510001;
...
constexpr ptrdiff_t dwEntityList = 0x4DA4F8C;
constexpr ptrdiff_t dwForceAttack = 0x31D6514;
constexpr ptrdiff_t dwForceAttack2 = 0x31D6520;
constexpr ptrdiff_t dwForceBackward = 0x31D64CC;
constexpr ptrdiff_t dwForceForward = 0x31D64D8;
constexpr ptrdiff_t dwForceJump = 0x524EECC;
constexpr ptrdiff_t dwForceLeft = 0x31D64F0;
constexpr ptrdiff_t dwForceRight = 0x31D64E4;
constexpr ptrdiff_t dwGameDir = 0x628800;
constexpr ptrdiff_t dwGameRulesProxy = 0x52C21AC;
constexpr ptrdiff_t dwGetAllClasses = 0xDB4F8C;
constexpr ptrdiff_t dwGlobalVars = 0x589CE8;
constexpr ptrdiff_t dwGlowObjectManager = 0x52ED560;
constexpr ptrdiff_t dwInput = 0x51F6550;
constexpr ptrdiff_t dwInterfaceLinkList = 0x947D24;
constexpr ptrdiff_t dwLocalPlayer = 0xD8D2BC;
constexpr ptrdiff_t dwMouseEnable = 0xD92E60;
constexpr ptrdiff_t dwMouseEnablePtr = 0xD92E30;
constexpr ptrdiff_t dwPlayerResource = 0x31D4840;
constexpr ptrdiff_t dwRadarBase = 0x51D9D04;
constexpr ptrdiff_t dwSensitivity = 0xDA42CC;
constexpr ptrdiff_t dwSensitivityPtr = 0xDA42A0;
constexpr ptrdiff_t dwSetClanTag = 0x8A1B0;
constexpr ptrdiff_t dwViewMatrix = 0x4D968A4;
constexpr ptrdiff_t dwWeaponTable = 0x51F7010;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xD2510002;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD97D60;
constexpr ptrdiff_t dwbSendPackets = 0xD75EA;
constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA7050;
constexpr ptrdiff_t m_pStudioHdr = 0x294C;
constexpr ptrdiff_t m_yawClassPtr = 0xD92AC0;
constexpr ptrdiff_t m_pitchClassPtr = 0x51D9FA0;
...
constexpr ptrdiff_t set_abs_angles = 0x1DFC70;
constexpr ptrdiff_t set_abs_origin = 0x1DFAB0;
constexpr ptrdiff_t is_c4_owner = 0x3BB960;
constexpr ptrdiff_t force_update_spectator_glow = 0x3AEE0A;
constexpr ptrdiff_t anim_overlays = 0x2980;
constexpr ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ptrdiff_t find_hud_element = 0x2DDAEA20;
