...
{
//signatures
constexpr ::std::ptrdiff_t m_fFirstHook = 0xB1DE0;
constexpr ::std::ptrdiff_t m_fSecondHook = 0xB1E20;
constexpr ptrdiff_t fakeLevel = 0x51F8954;
constexpr ptrdiff_t fakeRank = 0xD93B0001;
...
constexpr ptrdiff_t dwYawPtr = 0xD93B0002;
...
constexpr ptrdiff_t find_hud_element = 0x26F0FA00;
