...
{
//signatures
constexpr ::std::ptrdiff_t m_fFirstHook = 0xB1D70;
constexpr ::std::ptrdiff_t m_fSecondHook = 0xB1DB0;
...
constexpr ptrdiff_t dwEntityList = 0x4DA521C;
constexpr ptrdiff_t dwForceAttack = 0x31D6750;
constexpr ptrdiff_t dwForceAttack2 = 0x31D675C;
constexpr ptrdiff_t dwForceBackward = 0x31D678C;
constexpr ptrdiff_t dwForceForward = 0x31D6768;
constexpr ptrdiff_t dwForceJump = 0x524EFFC;
constexpr ptrdiff_t dwForceLeft = 0x31D6780;
constexpr ptrdiff_t dwForceRight = 0x31D67A4;
constexpr ptrdiff_t dwGameDir = 0x628800;
constexpr ptrdiff_t dwGameRulesProxy = 0x52C22EC;
constexpr ptrdiff_t dwGetAllClasses = 0xDB4FF4;
constexpr ptrdiff_t dwGlobalVars = 0x589CE8;
constexpr ptrdiff_t dwGlowObjectManager = 0x52ED6A8;
constexpr ptrdiff_t dwInput = 0x51F67E0;
constexpr ptrdiff_t dwInterfaceLinkList = 0x947774;
constexpr ptrdiff_t dwLocalPlayer = 0xD8D2CC;
constexpr ptrdiff_t dwMouseEnable = 0xD92E70;
constexpr ptrdiff_t dwMouseEnablePtr = 0xD92E40;
constexpr ptrdiff_t dwPlayerResource = 0x31D4AD0;
constexpr ptrdiff_t dwRadarBase = 0x51D9F94;
constexpr ptrdiff_t dwSensitivity = 0xDA42DC;
constexpr ptrdiff_t dwSensitivityPtr = 0xDA42B0;
constexpr ptrdiff_t dwSetClanTag = 0x8A1B0;
constexpr ptrdiff_t dwViewMatrix = 0x4D96B34;
constexpr ptrdiff_t dwWeaponTable = 0x51F72A0;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xD9E30002;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD97D70;
...
constexpr ptrdiff_t m_yawClassPtr = 0xD92AD0;
constexpr ptrdiff_t m_pitchClassPtr = 0x51DA230;
...
constexpr ptrdiff_t set_abs_angles = 0x1E07A0;
constexpr ptrdiff_t set_abs_origin = 0x1E05E0;
constexpr ptrdiff_t is_c4_owner = 0x3BC630;
constexpr ptrdiff_t force_update_spectator_glow = 0x3AF9FA;
constexpr ptrdiff_t anim_overlays = 0x2980;
constexpr ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ptrdiff_t find_hud_element = 0x2648F5A0;
